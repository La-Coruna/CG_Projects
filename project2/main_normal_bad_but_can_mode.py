...
def parsing_face_info(triangle_face_info):
    triangle = []
    for vertex_info_with_slash in triangle_face_info:
        ...
        triangle.append( [v_idx, texture_idx, vn_idx] )
    return triangle
...
def drop_callback(window, paths):
    ...
    for line in g_obj_file:
        ...
        if len(fields) == 0: # 빈 줄인 경우.
            ...
            #face == parsing_face_info(fields[1:])
            g_obj_f.append( face )
        #elif fields[-1] == '\\':
